...
const EditPostPage = ({ params }) => {
  ...
  const handleUpdateSubmit = async () => {
    ...
    console.log(postData, "kjjj update");
    ...
    if (res.ok) {
      const data = await res.json();
      console.log(data, "post update success");
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="col-span-3">
          <input
            type="text"
            id="title"
            className="w-full border border-gray-300 border-solid px-5 py-3 text-lg outline-none mb-5 dark:bg-gray-700"
        ...
        <div className="flex flex-col gap-5">
          ...
          <button
            type="button"
            className="text-white max-w-full bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
